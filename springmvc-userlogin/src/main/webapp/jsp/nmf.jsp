...
<body>
	...
	<hr>
	<div class="w3-center">
	    <h2>Opis segmenata NMF klasterizacije</h2>
	    <p w3-class="w3-large">Diferenciraju se tri segmenta dobijena NMF klasterizacijom.</p>
	</div>
	<button onclick="myAccFunc('Demo1')" class="w3-padding-16 w3-theme w3-button w3-block w3-left-align">Opis</button>
	<div id="Demo1" class="w3-hide">
	  <div class="w3-container">
	    <p>Razlike izmedju klastera su jako male, najmanje izmedju prvog i treceg klastera. Zapazeno je da su kod drugog 
		klastera broj i stepen ocenjivanja manji nego kod druga dva klastera. Takodje, primetno je da je i stepen 
		ocenjivanja najcitanijeg zanra manji nego kod ostalih.</p>
	  </div>
	</div>
